...
class _HomeBoardingAppState extends State<HomeBoardingApp> with TickerProviderStateMixin{
        ...
        body: Stack(
          ...
          children: [
            ...
            Positioned(
                right: 30.0,
                bottom: 30.0,
                child: ScaleTransition(child: isLastPage ? FloatingActionButton(
                    backgroundColor: Colors.white,
                    child: Icon(
                      Icons.arrow_forward,
                      color: Colors.black,
                    ),
                    onPressed: () {}) : Container(),scale: _scaleAnimation,)),
          ],
        ),
      ),
    );
